...
public class Main{
    public static void main(String[] args) {
       ...
       /* pizza.similar = sandwich;
        sandwich.similar = pizza;
        aqua.similar = water;
        water.similar = aqua;
        juice.similar = fruit_water;
        fruit_water.similar = juice;*/
        
        /**Выводим категории  */
      /*  pizza.category=Category.FOOD;
        sandwich.category=Category.FOOD;
        aqua.category=Category.FOOD;
        water.category=Category.FOOD;
        juice.category=Category.FOOD;
        fruit_water.category=Category.FOOD;*/
...
*/
      ...
      /* GenericItem foodItem = new FoodItem("Fruit Nectar", 7, 12.2f, "2020-01-05", (short) 12 );
       ...
       /* GenericItem apple = new FoodItem("Apple", 10, 12.2f, "2020-01-15", (short) 12 );
        ...
        //Сравнение
        System.out.println(tv.equals(juice));
       */      

...
public class FoodItem extends GenericItem {
     ...
     * { super(name, id, price); Date date; try { date = (new
     * SimpleDateFormat("yyyy-MM-dd")).parse(dateString); } catch (Exception ex) {
     * System.out.println("Cannot parse date"); date = null; } this.category =
     * Category.FOOD; this.dateofIncome = date; this.expires = expires; }
     */
